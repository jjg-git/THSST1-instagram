...
\label{sec:scopelimitations}
	...
	EDA will be performed exclusively on Instagram posts that contain both images and captions to ensure suitability for multimodal analysis. Posts lacking either modality are excluded. Social interaction metrics such as likes, comments, and follower counts are beyond the scope, as the study focuses solely on content based personality signals, not engagement behaviors.
	...
	The study will process captions in any language, including English, Filipino, regional dialects, or other languages. Emojis, hashtags, and links will be minimally cleaned but retained as meaningful tokens (e.g., links will be tokenized as "[LINK]"). This approach acknowledges the linguistic diversity and multimodal expression patterns of Filipino users.
	
	\textbf{Image processing:} \\
	The study will focus on two aspects:
	
	Photo Characteristics — including color, brightness, and image size.
	
	Image Content — identifying objects or scenes such as food, people, or locations.
...
This research addresses a critical gap in the emerging field of Filipino Automatic Personality Recognition (APR), particularly in the context of multimodal analysis. Rather than framing Filipino APR as a ``problem,'' this study recognizes it as a developing subfield that presents unique linguistic and cultural challenges requiring specialized approaches.

The majority of existing Filipino APR research focuses on text based data from platforms such as Twitter. While valuable, this narrow focus overlooks the rich, multimodal content shared on platforms like Instagram, where users express personality through both images and language.

This study makes several key contributions:

\begin{itemize}
	\item It expands Filipino APR by integrating image and text modalities, building upon successful multimodal approaches from other contexts.
	\item It acknowledges and addresses the complexities of Filipino linguistic expression, including code switching, emojis, and hashtags, which are prevalent in social media discourse.
	\item By conducting exploratory data analysis (EDA), the study establishes a foundational understanding of Filipino Instagram data relevant to personality recognition.
	\item The research demonstrates practical methods for multimodal feature extraction and fusion, tailored to the Philippine social media landscape.
\end{itemize}
