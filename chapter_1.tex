...
The PagkataoKo dataset’s methods were reviewed and given clearance by the Research Ethics Office of De La Salle University \citep{Tighe_Acorda_Agno_Gano_Go_Santiago_Sedillo_2022}. 

\begin{itemize}
	\item \textbf{Data Compliance:}
		\begin{itemize}
			\item Volunteers gave electronic consent
			\item  Social media data was collected in accordance with the developer policies of Twitter and Instagram.
	\end{itemize}
	
	\item \textbf{Privacy Protection:}
	\begin{itemize}
		\item Full anonymization of \texttt{UserID} and metadata
		\item Encrypted storage of raw posts
	\end{itemize}
	
	\item \textbf{Data Restrictions:}
	\begin{itemize}
		\item Research-only usage
		\item No commercial or re-identification purposes
	\end{itemize}
\end{itemize}
\end{mdframed}
%%\begin{itemize} 
