...
This study aims to explore a multimodal approach in the study of Filipino Automatic Personality Recognition. To achieve this, the study will pursue the following specific objectives:
...
\begin{enumerate}
	...
	\item To identify the effectiveness of different feature sets and machine learning algorithms for trait prediction.
...
\begin{enumerate}[label=\textbf{ \arabic*:}, leftmargin=*]
	...
	\item \textbf{Data Representation:} To represent a single instance in the dataset, both the text and image features will be normalized and compiled into one vector. The text feature to be fed into the machine learning is the \textit{caption}, the image features be the first five detected tag words.
	
	\item \textbf{Categorization of Data:} The label of the data will be one of the personality trait in the OCEAN model. Because of the use of classification in machine learning, the classes of the label are "yes" and "no", meaning whether the person (the instance of the dataset) has the personality trait or not, respectively.
\end{enumerate}
